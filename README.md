## containerd + criu for gokrazy

This package contains the static build of https://github.com/containerd/containerd / https://github.com/opencontainers/runc + https://github.com/seqeralabs/criu-static
...
```
gok add github.com/ascension-association/gk-containerd-criu
gok update
```
